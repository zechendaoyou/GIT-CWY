...
<div id="container">
    ...
    <div class="buy">
        ...
        <table class="buy" cellpadding="0" cellspacing="0">
            ...
            <tr class="h26 blue">
                <td><a href="info.jsp" title="攀高搓捶背靠垫按摩器（蓝 ）（定制）">&nbsp;&nbsp;&nbsp;&nbsp;攀高搓捶背靠垫按摩器（蓝色 ）（定制）</a></td>
            ...
            <tr class="h26 blue">
                <td><a href="info.jsp" title="郝彬美国口语-美国口语成功训练系统（MP3）">&nbsp;&nbsp;&nbsp;&nbsp;郝彬美国口语-美国口语成功训练系统（MP3）</a></td>
            ...
            <tr class="h26 blue">
                <td><a href="info.jsp" title="简.奥斯汀全集（DVD-9）（赠BBC产品目录...">&nbsp;&nbsp;&nbsp;&nbsp;简.奥斯汀全集（DVD-9）（赠BBC产品目录...</a></td>
